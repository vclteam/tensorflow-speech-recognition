...
snore_train_path = "data/snoretrain/"
    ...
    while True:
        ...
        for file in files:
            ...
            if target == Target.speaker:
                ...
                label = dense_to_one_hot((ord(file[0]) - 48) % 32, 32)
            elif target == Target.hotword:
                label = one_hot_word(file, pad_to=max_word_length)  #
            elif target == Target.word:
                label = string_to_int_word(file, pad_to=max_word_length)
